...
VALUES ('OWNER', 'test_owner', '$2a$10$8.UnVuG9HHgffUDAlk8qfOpFte2uTb.X.gij.w.s5x.x5x.x5x', '테스트사장', '01012345678', 'MALE', '1990-01-01', NOW(), NOW());
...
INSERT INTO users (role, login_id, password, name, phone, gender, birth, created_at, updated_at)
VALUES ('OWNER', 'owner1', '$2a$10$8.UnVuG9HHgffUDAlk8qfOpFte2uTb.X.gij.w.s5x.x5x.x5x', '레이지사장', '01011111111', 'FEMALE', '1995-01-01', NOW(), NOW());
...
INSERT INTO users (role, login_id, password, name, phone, gender, birth, created_at, updated_at)
VALUES ('OWNER', 'owner2', '$2a$10$8.UnVuG9HHgffUDAlk8qfOpFte2uTb.X.gij.w.s5x.x5x.x5x', '버터사장님', '01022222222', 'FEMALE', '1993-05-05', NOW(), NOW());
...
INSERT INTO users (role, login_id, password, name, phone, gender, birth, created_at, updated_at)
VALUES ('OWNER', 'owner3', '$2a$10$8.UnVuG9HHgffUDAlk8qfOpFte2uTb.X.gij.w.s5x.x5x.x5x', '도우터사장', '01033333333', 'MALE', '1988-08-08', NOW(), NOW());
...
INSERT INTO users (role, login_id, password, name, phone, gender, birth, created_at, updated_at)
VALUES ('OWNER', 'owner4', '$2a$10$8.UnVuG9HHgffUDAlk8qfOpFte2uTb.X.gij.w.s5x.x5x.x5x', '462사장님', '01044444444', 'FEMALE', '1990-12-25', NOW(), NOW());
...
INSERT INTO users (role, login_id, password, name, phone, gender, birth, created_at, updated_at)
VALUES ('OWNER', 'owner5', '$2a$10$8.UnVuG9HHgffUDAlk8qfOpFte2uTb.X.gij.w.s5x.x5x.x5x', '언필드사장', '01055555555', 'MALE', '1996-06-06', NOW(), NOW());
...
INSERT INTO users (role, login_id, password, name, phone, gender, birth, created_at, updated_at)
VALUES ('OWNER', 'owner6', '$2a$10$8.UnVuG9HHgffUDAlk8qfOpFte2uTb.X.gij.w.s5x.x5x.x5x', '이퀄리사장', '01066666666', 'MALE', '1992-02-02', NOW(), NOW());
