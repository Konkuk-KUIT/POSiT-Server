...
-- ============================================================
-- store.description 일괄 수정 양식
-- (business_number로 가게 1개 정확히 타겟)
-- ============================================================

UPDATE store
SET description = '에그타르트 한 입에 느껴지는 고소함'
WHERE business_number = '1000000001';

UPDATE store
SET description = '아늑한 카페에서 즐기는 휘낭시에 한입'
WHERE business_number = '1000000002';

UPDATE store
SET description = '데이트하기 좋은 감성 가득한 공간'
WHERE business_number = '1000000003';

UPDATE store
SET description = '수제로 완성한 케이크의 진한 매력'
WHERE business_number = '1000000004';

UPDATE store
SET description = '시원한 망고빙수로 여름 극복'
WHERE business_number = '1000000005';

UPDATE store
SET description = '반려동물과 함께하는 편안한 카페 체험'
WHERE business_number = '1000000006';

-- ============================================================
-- store.lot_address 일괄 수정
-- ============================================================

UPDATE store
SET lot_address = '화양동 3-75'
WHERE business_number = '1000000001';

UPDATE store
SET lot_address = '서울 광진구 화양동 16-37'
WHERE business_number = '1000000002';

UPDATE store
SET lot_address = '화양동 11-17'
WHERE business_number = '1000000003';

UPDATE store
SET lot_address = '서울 광진구 화양동 46-2'
WHERE business_number = '1000000004';

UPDATE store
SET lot_address = '서울 광진구 화양동 49-15'
WHERE business_number = '1000000005';

UPDATE store
SET lot_address = '서울 광진구 자양동 7-30'
WHERE business_number = '1000000006';

UPDATE store
SET lot_address = '역삼동 702-16'
WHERE business_number = '1000000007';

UPDATE store
SET lot_address = '서울 강남구 역삼동 704-47'
WHERE business_number = '1000000008';

UPDATE store
SET lot_address = '대치동 897'
WHERE business_number = '1000000009';

UPDATE store
SET lot_address = '서울 강남구 대치동 907-12'
WHERE business_number = '1000000010';

UPDATE store
SET lot_address = '서울 강남구 대치동 897-16'
WHERE business_number = '1000000011';

UPDATE store
SET lot_address = '서울 강남구 대치동 899-16'
WHERE business_number = '1000000012';